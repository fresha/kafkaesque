defmodule Kafkaesque.DummyConsumerV2 do
  @moduledoc false
  ...
  use Kafkaesque.Consumer,
    ...
    topics_config: %{
      ...
      "dummy_events_with_plugins" => %{
        decoder_config: {Kafkaesque.Decoders.DebeziumProtoDecoder, [schema: Envelope]},
        handle_message_plugins: [{Kafkaesque.Plugins.DummyHandleMessagePlugin, []}]
      },
      "dummy_events_with_dead_letter" => %{
        decoder_config: {Kafkaesque.Decoders.DebeziumProtoDecoder, [schema: Envelope]},
        dead_letter_producer:
          {Kafkaesque.DeadLetterQueue.KafkaTopicProducer, [topic: "some_topic", worker_name: :some_worker]},
